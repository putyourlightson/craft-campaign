    ...
    protected function createTables(): bool
    {
        if (!$this->db->tableExists('{{%campaign_campaigns}}')) {
            $this->createTable('{{%campaign_campaigns}}', [
                ...
                'clicked' => $this->integer()->notNull(),
                'opens' => $this->integer()->notNull(),
                'clicks' => $this->integer()->notNull(),
                'unsubscribed' => $this->integer()->notNull(),
                'complained' => $this->integer()->notNull(),
                'bounced' => $this->integer()->notNull(),
