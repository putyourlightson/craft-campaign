 ...
 */
class UnsubscribeContacts extends ElementAction
{
    ...
    {
        return Craft::t('campaign', 'Unsubscribe from “{mailingList}”', ['mailingList' => $this->mailingListTitle]);
    }
...
EOD;
    ...
    public function performAction(ElementQueryInterface $query): bool
    {
        ...
        foreach ($contacts as $contact) {
            ...
            Campaign::$plugin->log('Contact “{email}” unsubscribed from “{mailingList}”.', [
                'email' => $contact->email,
                'mailingList' => $this->mailingListTitle,
            ]);
        }

        $this->setMessage(Craft::t('campaign', 'Contacts successfully unsubscribed from “{mailingList}”.', ['mailingList' => $this->mailingListTitle]));
