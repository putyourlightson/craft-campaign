...
return [
    ...
    'The value in the CSV file should be an array of element IDs, for example: {value}' => '',
    'The value in the CSV file should be an array of option values, for example: {value1}. Double quotation marks should be used for escaping string values, for example: {value2}' => '',
