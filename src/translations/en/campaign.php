...
return [
    ...
    'Are you sure you want to unsubscribe from all mailing lists?' => '',
    ...
    'Choose a campaign' => '',
    'Choose a CSV file to import contact data. The first line of the file should contain the column headers.' => '',
    ...
    'Plaintext Body' => '',
    'Plaintext Template' => '',
    'Please verify that you would like to unsubscribe from all mailing lists by clicking on the following link:' => '',
    ...
    'Segment matching' => '',
    'Semicolon' => '',
    'Select the delimiter used to separate columns in the CSV file.' => '',
    ...
    'The occurrences of the selected days of the week on which to send.' => '',
    ...
    'The segment(s) to filter contacts by.' => '',
    ...
    'Unsent' => '',
    'Unsubscribe' => '',
    'Unsubscribe confirmation is invalid.' => '',
    ...
    'Unsubscribed' => '',
    'Unsubscribing from all mailing lists through a form is not allowed.' => '',
    'Untitled campaign' => '',
    ...
    'Whether contacts must match all or any of the selected segments.' => '',
    ...
    'Whether to send on specific days of the month or on selected days of the week.' => '',
    ...
    'You have successfully unsubscribed from all mailing lists.' => '',
