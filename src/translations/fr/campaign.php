...
return [
    ...
    'Subject' => 'Sujet',
    'Subscribe Success Template' => 'Template de confirmation de subscription',
    'Subscribe Verification Email Subject' => 'Sujet du mail de confirmation de subscription',
    'Subscribe Verification Email Template' => 'Template du mail de confirmation de subscription',
    ...
    'The plaintext template to use when sending a plaintext version.' => 'Le template de texte en clair à utiliser lors de l’envoi d’une version en texte pur.',
    ...
    'The template to use for the verification email that is sent to contacts who submit a subscribe form (leave blank for default message template).' => 'Le template à utiliser pour l’email de vérification envoyé aux contacts qui remplissent un formulaire d’inscription (laisser vide pour le template par défaut).',
    'The template to use for the verification email that is sent to contacts who submit an unsubscribe form (leave blank for default message template).' => 'Le template à utiliser pour l’email de vérification envoyé aux contacts qui remplissent un formulaire de désabonnement (laisser vide pour le template par défaut).',
    'The template to use when a contact successfully subscribes to a mailing list (leave blank for default message template).' => 'Le template à utiliser lorsqu’un contact s’inscrit avec succès à une liste de diffusion (laisser vide pour le template par défaut).',
    'The template to use when a contact successfully unsubscribes from a mailing list (leave blank for default message template).' => 'Le template à utiliser lorsqu’un contact se désabonne avec succès d’une liste de diffusion (laisser vide pour le template par défaut).',
    'The template to use when a contact verifies their email address (leave blank for default message template).' => 'Le template à utiliser lorsqu’un contact vérifie son adresse mail (laisser vide pour le template par défaut).',
    'The time of day at which to send (recommended).' => 'L’heure à laquelle envoyer (recommandé).',
