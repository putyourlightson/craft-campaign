...
return [
	...
	'Campaign Stats' => 'Statiqtiques de newsletter',
	...
	'Plaintext Body' => '',
	'Plaintext Template' => 'Modèle texte pur',
	...
	'Subscribe Verification Success Template' => 'Maquette de la confirmation de l’abonnement',
	...
	'System issues found!' => 'Des problèmes systèmes sont survenus !',
	...
	'The mailing list(s) to exclude from this sendout. Contacts in these mailing lists will be excluded even if they are subscribed to one of the mailing lists above.' => 'Le(s) liste(s) de diffusion à exclure de cette campagne. Les contacts de ces listes de diffusion seront exclus même s’ils sont souscris à l’une des listes de diffusion ci-dessus.',
	...
	'The plaintext template to use when sending a plaintext version.' => 'Le modèle de texte en clair à utiliser lors de l’envoi d’une version en texte pur.',
	...
	'The segment(s) to filter contacts by. Only contacts that fulfil the criteria in all selected segments will receive the sendout.' => 'Le(s) segment(s) avec lequel filter les contacts. Seuls les contacts qui remplissent les critères dans tous les segments sélectionnés recevront l’envoi.',
	...
	'Whether to enable anonymous tracking of contact interactions.' => 'Permettre le suivi anonyme des interactions avec les contacts.',
	'Years' => 'Années',
	...
	'You have successfully subscribed to the mailing list.' => 'Vous êtes inscrit à la liste de diffusion.',
	'You have successfully unsubscribed from the mailing list.' => 'Vous êtes désabonné de la liste de diffusion.',
